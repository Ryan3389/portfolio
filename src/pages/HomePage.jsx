...
const HomePage = () => {
    return (
        <section className="bg-gray-900 text-white h-[90vh]">
            <div className="grid max-w-screen-xl px-4 py-8 mx:auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 m-auto w-[80%]">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    <a target='_blank' href="/RyanCuthbert_resume.pdf" download="RyanCuthbert_resume.pdf" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center border border-gray-300 rounded-lg hover:bg-gray-800 focus:ring-4 focus:ring-gray-100 dark:text-white ">Resume</a>
                    <a target='_blank' href="https://github.com/Ryan3389" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center border border-gray-300 rounded-lg hover:bg-gray-800 focus:ring-4 focus:ring-gray-100 dark:text-white mx-5">GitHub</a>
                </div>
