    ...
    return (
        <>
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 224, 0.1)] transition">
                <h3 className="text-2xl font-bold mb-2 text-center">LegendMeter</h3>
                <p className="text-gray-400 mb-5 text-xl">Upload player stats and predict to predict if they will be inducted into the Hall of Fame</p>
                <div>
                    {["React", "Python", "Flask", "Scikit Learn"].map((tech, index) => (
                    ...
                    <div className="my-10">
                        <a rel="noopener" href="https://github.com/Ryan3389/python-predict" target="_blank" className="text-blue-400 hover:text-blue-300 transition-colors my-5">View Project</a>
                    </div>
                </div>
            </div>
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 224, 0.1)] transition">
                ...
                <div>
                    {["React", "Express.js", "JWT", "OpenAI API"].map((tech, index) => (
                        <span key={index} className="bg-blue-500/10 text-blue-500 py-1 px-3 mx-2 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59, 130, 224, 0.1)] transition-all">
                            {tech}
                        </span>
                    ))}
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 224, 0.1)] transition">
                ...
                <div>
                    {["Java", "Spring Boot", "Spring Security", "PostgreSQL"].map((tech, index) => (
                        <span key={index} className="bg-blue-500/10 text-blue-500 py-1 px-3 mx-2 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59, 130, 224, 0.1)] transition-all">
                            {tech}
                        </span>
                    ))}
...
/*
"Java", "Spring Boot", "Spring Security", "Java Mail Sender", "PostgreSQL", "JWT"
*/
