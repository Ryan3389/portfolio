            ...
            <div className="grid max-w-screen-xl px-4 py-8 mx:auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 m-auto w-[80%]">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    <div className='home-btn-container'>
                        <a href="/RyanCuthbert_resume.pdf" download="RyanCuthbert_resume.pdf" className="px-5 py-3 font-medium border border-btnBorder bg-btn bg-btnBackground rounded-lg hover:bg-btnHover">Resume</a>
